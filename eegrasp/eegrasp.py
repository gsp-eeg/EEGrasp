...
class EEGrasp():
    ...
    def _init_from_mne(self, data):
        ...
        self.coordinates = np.array([
            pos
            for _, pos in info.get_montage().get_positions()['ch_pos'].items()
        ])
    ...
    def compute_distance(self,
        ...
        self.distances = compute_distance(coordinates=coordinates,
                                          method=method,
                                          normalize=normalize)
    ...
    def compute_graph(self,
        ...
        self.graph, self.graph_weights = compute_graph(W=W,
                                                       epsilon=epsilon,
                                                       sigma=sigma,
                                                       distances=distances,
                                                       graph=graph,
    ...
    def interpolate_channel(self,
                            missing_idx: int | list[int] | tuple[int],
                            graph=None,
                            data=None):
    ...
    def fit_epsilon(self,
        ...
        fit_epsilon(missing_idx=missing_idx,
                    data=data,
                    distances=distances,
                    sigma=sigma)
    ...
    def fit_sigma(self,
        ...
        return fit_sigma(missing_idx=missing_idx,
                         data=data,
                         distances=distances,
                         epsilon=epsilon,
                         min_sigma=min_sigma,
    ...
    def plot(self,
        ...
        return plot_graph(eegrasp=self,
                          graph=graph,
                          signal=signal,
                          coordinates=coordinates,
                          labels=labels,
